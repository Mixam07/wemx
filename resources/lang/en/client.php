<?php return array(
    ...
    'game_panel_title' => 'Game Panel',
    'game_pagel_caption' => 'Professional and Simple',
    'extreme_performance_title' => 'Extreme Performance',
    'extreme_performance_caption' => 'AMD® Ryzen™ 9 (4.2 GHz)',
    'automatic_installation_title' => 'Automatic Installation',
    'automatic_installation_caption' => 'Installation in a few clicks',
    'game_panel_desc' => 'Our comprehensive and user-friendly game panel is designed to be very easy and fast to use, offering everything you need to maintain a game server. Benefit from exploring a wide range of exclusive features, specially designed to enhance your experience.',
    'lastest_generation_processors_title' => 'Latest Generation Processors',
    'lastest_generation_processors_desc' => 'Optimal gameplay hinges on single-threaded performance, and our AMD Ryzen 9 4.2 GHz processors leverage cutting-edge technology. Engineered for unparalleled smoothness and responsiveness, these state-of-the-art processors ensure an exceptional gaming experience.',
    'memory_title' => 'DDR4 2666 MHz Memory',
    'memory_desc' => 'Every physical server boasts 128GB of DDR4 ECC 2666 MHz RAM, guaranteeing ample memory for your game server\'s needs. This robust configuration ensures unwavering performance and an uninterrupted gaming experience. With this substantial memory capacity, your game server is primed to consistently deliver a seamless and immersive gaming environment.',
    'network_title' => '1Gbps Network',
    'network_desc' => 'Every server enjoys high-speed 1Gbps connectivity, powered by our advanced and interconnected network infrastructure. This setup guarantees minimal latency, ensuring an entirely lag-free gaming experience. Immerse yourself in smooth, responsive online gaming without any delay, courtesy of our optimized network performance.',
    'storage_title' => 'NVMe Storage',
    'storage_desc' => 'Our servers boast the latest, top-tier hardware, featuring ultra-fast hard drives utilizing NVMe storage technology. This cutting-edge setup guarantees exceptional speed and efficiency for your games, resulting in reduced loading times and enhanced overall game performance.',
    'anti_ddos_title' => 'Anti-DDoS',
    'anti_ddos_desc' => 'Game servers come fortified with robust protection, a fusion of hardware and software defenses against DDoS attacks. With our state-of-the-art Anti-DDoS technology, we assure not just server security but also game stability. Enjoy your games with complete peace of mind, knowing your server is shielded by top-tier security measures.',
    'linux_title'=> 'Linux',
    'linux_desc' => 'We\'ve opted for the Linux operating system across our entire infrastructure, specifically leveraging a refined version of the Debian distribution. This deliberate choice guarantees peak performance and unwavering reliability. With Linux serving as the backbone of our servers, we deliver a stable and efficient platform for your game server.',
