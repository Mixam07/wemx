<div class="flex flex-wrap items-center justify-between lg:order-2">
    ...
    <div id="dropdownPallete"
         class="z-20 hidden w-full max-w-sm divide-y divide-gray-100 rounded-lg shadow dark:divide-gray-700 dark:bg-gray-800"
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
            <div class="-left-32 top-10 z-50 w-96 list-none rounded p-3 text-base shadow dark:bg-gray-800">
    ...
    @auth
        ...
        <!-- Dropdown menu -->
        <div
            class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
        ...
        <!-- Dropdown menu -->
        <div
            class="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded text-base shadow dark:divide-gray-600 dark:bg-gray-700"
            id="userMenuDropdown">
            <div class="px-4 py-3">
            ...
            <ul class="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="userMenuDropdownButton">
                ...
                <li aria-labelledby="dropdownNavbarLink">
                    ...
                    <div id="doubleDropdown"
                         class="z-10 hidden w-44 divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
