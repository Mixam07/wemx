class FileManager {
    ...
    updateTable(files) {
        ...
        if (this.currentPath !== '/') {
            this.tableBody.appendChild(this.createBackRow());
        }
        files.forEach(file => {
    ...
    createBackRow() {
        ...
        td.colSpan = 5;
        td.className = 'py-4 ps-2 pe-0 font-medium text-gray-900 whitespace-nowrap dark:text-white';
        td.innerHTML = '<i class=\'bx bx-arrow-back\'></i>';
        tr.appendChild(td);
        return tr;
    }
