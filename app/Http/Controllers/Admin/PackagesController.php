...
class PackagesController extends Controller
{
    ...
    */
    public function updateConfigOption(Package $package, ConfigOption $option, Request $request)
    {
        ...
        //     'select.description' => 'required|string',
        //     'select.options' => 'required|array',
        //     'select.options.*.value' => 'required|string',
        //     'select.options.*.name' => 'required|string',
        //     'select.options.*.monthly_price' => 'required|numeric|min:0',
        // ]);

        $option->update(['data' => $request->get('data')]);
