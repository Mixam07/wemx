...
Route::get('/suspended', [Client\DashboardController::class, 'suspended'])->name('suspended')->withoutMiddleware(Punishments::class);
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/user/settings')->group(function () {
        ...
        Route::post('/update-address', [Client\UserController::class, 'updateAddress'])->name('update-address')->withoutMiddleware(Maintenance::class);
